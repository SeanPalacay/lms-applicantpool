...
const EmployeeProfile = () => {
  ...
  useEffect(() => {
    const fetchProfileData = async () => {
      try {
        ...
        // 2. Get activity data
        const activityData = await employeeService.getActivity();
  ...
  const viewResume = async (resumePath) => {
    try {
      setLoading(true);
      const resumeBlob = await employeeService.getResume(resumePath);
  ...
  const updateProfile = async (e) => {
    ...
    try {
      ...
      setProfile((prev) => ({
        ...
        resume_path: updatedProfile.resume_path || prev.resume_path,
        resumes: updatedProfile.resumes || prev.resumes
      }));
      
      // Update username in localStorage
      localStorage.setItem('userName', updatedProfile.full_name || profile.full_name);
  ...
  const changePassword = async (e) => {
    ...
    try {
      ...
      // Change password using employee service
              ...
              >
                ...
                <div className="account-info" style={{ 
                  ...
                  <div style={{ display: 'grid', gap: '0.75rem' }}>
                    ...
                    {profile.department && (
                      <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
                        <span style={{ fontSize: '0.8125rem', color: '#6B7280' }}>Department</span>
