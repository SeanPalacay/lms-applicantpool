...
try {
    ...
    // Replace hardcoded traineeId with actual user ID from token or session
    $traineeId = 3; // Replace with actual user ID

    // Debugging: Check traineeId
    error_log("Trainee ID: " . $traineeId);
