<?php
// lms-forbes/backend/api/trainer/activity.php
...
try {
    ...
    $activityQuery = "
        SELECT activity_type, activity_time, details
        FROM user_activity
    ...
    error_log('Error in activity.php: ' . $e->getMessage());
    http_response_code(500);
    echo json_encode(['error' => 'An error occurred while fetching activity information']);
}
?>