<?php
// lms-forbes/backend/api/trainer/milestone_details.php
...
// Check if the trainer has access to this milestone
if ($milestone['created_by'] != $trainerId) {
  http_response_code(403);
  echo json_encode(['error' => 'You do not have permission to access this milestone']);
  exit;
}
